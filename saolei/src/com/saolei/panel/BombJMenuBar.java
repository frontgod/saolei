...
import com.saolei.dialog.AboutSweeping;
import com.saolei.dialog.HeroDialog;
import com.saolei.dialog.UserDefinedJDialog;
...
public class BombJMenuBar extends JMenuBar {
	...
	JMenu menuGame = new JMenu("游戏(G)");			//菜单

	JMenu menuHelp = new JMenu("帮助(H)");			//菜单项
